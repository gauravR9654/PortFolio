...
export default function stickyNavbar() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
     <Typography
      ...
      >
        ...
        <a href="/skills" className="flex items-center text-black ">
    ...
    <Typography
      ...
      >
        ...
        <a href="#" className="flex items-center text-black">
          <span className="font-serif">My Experience</span>
        </a>
      </Typography>
      <Typography
        as="li"
      ...
      >
        ...
        <a href="#" className="flex items-center text-black">
          <span className="font-serif">My Contact</span>
        </a>
      </Typography>
    </ul>
  );
  ...
  return (
    <Navbar className="mx-auto bg-gray-300 max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <Typography
          as="a"
          href="#"
          className="mr-4 cursor-pointer py-1.5 font-large text-black "
        >
          <span className="font-serif fon">Gaurav's Portfolio</span>
        </Typography>
